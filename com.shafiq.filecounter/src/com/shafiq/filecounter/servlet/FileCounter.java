...
public class FileCounter extends HttpServlet {
	...
	// before destroying this, save visit-count to file or release any resources,
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		PrintWriter out = response.getWriter();// for sending PRINT (chars) <> to send binary data use
												// .getOutputStream() & ServletOutputStream obj
