package shafiq.election.servlets;
...
import shafiq.election.model.ElectionManager;
...
public class VoteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		Voter voter = (Voter) session.getAttribute("voter");//authenticated voted was saved in session
		try {
		if (voter == null) {
