...
<body>
	<%
	//ArrayList<MenuItem> menuItems = (ArrayList<MenuItem>)request.getAttribute("menuItems");
	//err:  java.util.LinkedList cannot be cast to java.util.ArrayList
...
<form method="post">
	...
	Click to place order: <input value="Place Order" type="button"/>
</form>
</body>
</html>